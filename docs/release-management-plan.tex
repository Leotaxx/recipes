...
\begin{titlepage}
  ...
  {\large Xinyu Yuan\\[0.4cm]}
  {\large TU Dublin DevOps\\[2cm]}
  \vfill
  {\large \today}
\end{titlepage}
\tableofcontents
...
The following links support the deployment demonstration and provide direct evidence of the working CI/CD pipeline and live service endpoint.

\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.28\linewidth}>{\raggedright\arraybackslash}p{0.66\linewidth}@{}}
\toprule
\textbf{Evidence} & \textbf{URL} \\
\midrule
\endhead
GitHub Actions deployment job & \url{https://github.com/Leotaxx/recipes/actions/runs/25599395902/job/75150734847} \\
Live RecipeOps deployment & \url{http://62.238.23.123} \\
\bottomrule
\end{longtable}
\end{document}
